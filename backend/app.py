...
chapters = [
    {
        ...
        "name": "Algebra",
        "questions": [
            {"id":3,"text":"Which amendment is known as the 'Mini-Constitution' due to its significant changes in various parts of the Constitution?","options":["7th Amendment","42nd Amendment","44th Amendment","73rd Amendment"],"correctAnswer":"42nd Amendment","Difficulty":"Easy","Type":"factual","Subtopic":"Unequal Status with Lok Sabha","explanation":"The 42nd Amendment Act of 1976 is known as 'Mini-Constitution' due to the important and large number of changes it made in various parts of the Constitution."},
    ...
    },
    {
        ...
        "name": "Geometry",
        "questions": [
                {"id":3,"text":"Which amendment is known as the 'Mini-Constitution' due to its significant changes in various parts of the Constitution?","options":["7th Amendment","42nd Amendment","44th Amendment","73rd Amendment"],"correctAnswer":"42nd Amendment","Difficulty":"Easy","Type":"factual","Subtopic":"Parliamentary Privileges","explanation":"The 42nd Amendment Act of 1976 is known as 'Mini-Constitution' due to the important and large number of changes it made in various parts of the Constitution."},
                {"id":4,"text":"Which of the following is not a Fundamental Duty as per the Indian Constitution?","options":["To uphold and protect the sovereignty, unity, and integrity of India","To defend the country and render national service when called upon to do so","To pay taxes","To safeguard public property and to abjure violence"],"correctAnswer":"To pay taxes","Difficulty":"Hard","Type":"factual","Subtopic":"Breach of Privilege and Contempt of the House","explanation":"Paying taxes, though a civic duty, is not listed under the Fundamental Duties in the Indian Constitution."}
             ]
    },
    {
        "subjectId": 2,
...
def get_polity_content():
    try:
        with open('polity.json', 'r') as file:
            polity_content = json.load(file)
            formatted_content = []
            chapter_content = polity_content["Polity Laxmikanth"]["Polity Chapter 3"]
            for title, content in chapter_content.items():
                formatted_content.append({"title": title, "content": content})
